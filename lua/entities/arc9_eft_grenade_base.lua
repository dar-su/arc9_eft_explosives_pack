...
function ENT:Detonate()
    ...
    if self:WaterLevel() > 0 then
        ...
        self:EmitSound(self.watersound, 100, 100, 1, CHAN_AUTO, 0, 0, ARC9.EveryoneRecipientFilter)
    else
        ...
        if self:checkindoor() then
            ...
            self:EmitSound(self.distantIndoorSound, 0, 100, 0.5, CHAN_AUTO, 0, 0, ARC9.EveryoneRecipientFilter)
            ...
            self:EmitSound(self.distantSound, 0, 100, 0.5, CHAN_AUTO, 0, 0, ARC9.EveryoneRecipientFilter)
        end 
